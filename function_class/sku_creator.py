...
class SkuSetter(object, ):
    ...
    def __init__(self,
                 sku_info,
                 main_images="unknown",
                 sku_template_name=settings.CURRENT_CONFIG.get("sku_template_file"),
                 ):
    ...
    def skuimage_extraction(self):
        ...
        return self.sku_image_list

    def skus_setting(self):
        """
        更改skus的算法 skuimage 然后分别设置三个尺寸
        """
        self.skuimage_extraction()  # 先填充sku_images_list
